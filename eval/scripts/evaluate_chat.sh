...
for model_dir in "${eval_dirs[@]}"; do
  ...
  output_dir="../eval_out_${output_suffix}"
  summary_path="../eval_sum_${output_suffix}.txt"
  ...
  bash evaluate_llama_chat.sh ${model_dir} ${output_dir} ${summary_path}
  # bash evaluate_qwen.sh ${model_dir} ${output_dir} ${summary_path}
